...
const CryptoDetails = () => {
    ...
    // loader if data is still fetching from API
        ...
        <>
            <Col className="coin-detail-container">
                <Col className="coin-heading-container">
                    ...
                    <p>{cryptoDetails.name} (USD) live price. View value stats, market cap and supply.</p>
                </Col>
                ...
                <Col className="stats-container">
                    <Col className="coin-value-statistics">
                        <Col className="coin-value-statistics-heading">
                            <Title level={3} className="coin-details-heading">{cryptoDetails.name} Value Stats</Title>
                        </Col>
